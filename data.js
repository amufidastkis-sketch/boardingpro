...
const programs = [
  ...
  { id: 'PPTAK', name: 'PPTAK', description: 'Program Pendidikan Tahfizh Al-QurΓÇÖan', color: 'green', pkl: false },
...
const seedData = {
  internalAccounts: [
    ...
    { id: 'ACC-MASTER', role: 'master_admin', username: 'admin.stkis', password: 'StkIs#2026!Pro', name: 'Master Admin MaΓÇÖhad', nama: 'Master Admin MaΓÇÖhad', passwordChangeCount: 0, status: 'Aktif', active: true, master: true },
  ...
  events: [
    ...
    { id: 'EV-03', date: '2026-09-19', title: 'TasmiΓÇÖ Akbar', location: 'Masjid', audience: 'PPTAK', status: 'Draft' }
  ],
  activities: [
  ...
  announcements: [
    { id: 'ANN-001', title: 'Kajian Akbar Maulid Nabi', detail: 'Seluruh santri mengikuti kajian setelah Maghrib di masjid.', date: '2026-09-06', author: 'Admin MaΓÇÖhad' },
